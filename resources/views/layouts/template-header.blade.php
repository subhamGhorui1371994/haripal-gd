...
{{--                                <li class="{{Request::segment(1) === 'contact' ? 'active' : ''}}"><a href="{!! url('contact') !!}">Contact</a></li>--}}
                                ...
                                <li class="{{Request::segment(1) === 'resource-person' ? 'active' : ''}}"><a href="{!! url('resource-person') !!}">Staff</a></li>

                                <li class="{{Request::segment(1) ==='achievement' ? 'active' : ''}}"><a href="{!! url('co-curricular') !!}">Achievement</a>
                                    <ul>
...
{{--                                <li class="{{Request::segment(1) === 'contact' ? 'active' : ''}}"><a href="{!! url('contact') !!}">Contact</a></li>--}}
                                ...
                                <li class="{{Request::segment(1) === null ? 'active' : ''}}"><a href="{!! url('/') !!}">Home</a></li>
                                <li class="{{Request::segment(1) === 'history' ? 'active' : ''}}"><a href="{!! url('/history') !!}">History</a></li>
                                <li class="{{Request::segment(1) === 'administration' ? 'active' : ''}}"><a href="{!! url('/administration') !!}">Administration</a></li>
                                <li class="{{Request::segment(1) === 'resource-person' ? 'active' : ''}}"><a href="{!! url('resource-person') !!}">Staff</a></li>

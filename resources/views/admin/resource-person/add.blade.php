    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group resource-person-course">
                ...
                {!! Form::select('course[]',['secondary'=>'Secondary', 'higherSecondary' => 'Higher Secondary'], '',['id'=>'course', 'class'=>'form-control select-2', 'multiple'=>'multiple', 'required'=>'required', 'data-msg-required'=>'Please select resource person course.'])!!}
                <span class="validation-errors"></span>
            </div>

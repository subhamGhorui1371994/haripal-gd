...
@section('content')
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            {{ Form::open(array('method' => 'PATCH','route' => ['resource-person.update',$resourcePerson->id], 'class'=>'form-vertical', 'id' => 'portfolio_form', 'files' => true )) }}
            ...
            <div class="form-group">
                ...
                {!! Form::select('resource_person_type',$resourcePersonTypes, $resourcePerson->resource_person_type,['id'=>'resource_person_type', 'class'=>'form-control select-2', 'required'=>'required', 'data-msg-required'=>'Please select resource person type.'])!!}
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" required data-msg-required="Please enter name." value="{{$resourcePerson->name ?? ''}}">
                <span class="validation-errors"></span>
            </div>

            <div class="form-group">
                <label class="control-label text-bold" for="email">Email <span class="required-fields">*</span></label>
                <input type="email" name="email" id="email" class="form-control" required data-msg-required="Please enter email." value="{{$resourcePerson->email ?? ''}}">
                <span class="validation-errors"></span>
            </div>

            <div class="form-group">
                <label class="control-label text-bold" for="mobile">Mobile <span class="required-fields">*</span></label>
                <input type="text" name="mobile" id="mobile" class="form-control" required data-msg-required="Please enter mobile." value="{{$resourcePerson->mobile ?? ''}}">
                <span class="validation-errors"></span>
            </div>

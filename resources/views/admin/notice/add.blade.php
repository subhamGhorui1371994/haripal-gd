...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Notice</h3>
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => 'admin/notice','role' => 'form', 'class'=>'form-vertical', 'id' => 'portfolio_form','files' => true ]) !!}

            <div class="form-group">
                <label class="control-label text-bold" for="date">Date <span class="required-fields">*</span></label>
                <input type="text" name="date" id="date" class="form-control" required data-msg-required="Please select notice date.">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="5" id="description" name="description" required data-msg-required="Please enter notice description."></textarea>
                <span class="validation-errors"></span>
            </div>

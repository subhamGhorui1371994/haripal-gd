...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Gallery Category</h3>
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => 'admin/gallery-category','role' => 'form', 'class'=>'form-vertical', 'id' => 'portfolio_form','files' => true ]) !!}
            <div class="form-group">
                <label class="control-label text-bold" for="category_id">Category <span class="required-fields">*</span></label>
                <input type="text" class="form-control" name="category_name" id="category_name" required data-msg-required="Please enter a category name.">

...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Gallery Category</h3>
            <div class="heading-elements">
                <a href="{{ url('admin/gallery-category/create') }}" class="btn btn-primary">Add Category</a>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: base_url + '/admin/gallery-category/get-list',
                    type: 'POST',
                ...
                columns: [
                    ...
                    {title: 'Created', data: 'created_at', className: 'text-center', width: '20%'},
                    {
                        title: 'Action',
                        data: null,
                        ...
                        mRender: function (data, type, row) {
                            return '<a href="' + base_url + '/admin/gallery-category/' + row.id + '/edit" style="margin-right: 1.5rem"><i class="icon-pencil"></i></a>' +
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this category?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/gallery-category/delete/' + delete_id;
                                }
                            },
                        );
                    });

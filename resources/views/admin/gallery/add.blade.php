...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Gallery Image</h3>
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => 'admin/gallery','role' => 'form', 'class'=>'form-vertical', 'id' => 'portfolio_form','files' => true ]) !!}
            <div class="form-group">
                <label class="control-label text-bold" for="category_id">Category <span class="required-fields">*</span></label>
                {!! Form::select('category_id',$galleryCategory, '',['id'=>'category_id', 'class'=>'form-control select-2', 'required'=>'required', 'data-msg-required'=>'Please select a category.'])!!}

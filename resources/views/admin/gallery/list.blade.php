...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Gallery</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: base_url + '/admin/gallery/get-list',
                    type: 'POST',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        mRender: function (data, type, row) {
                            return `<img src="${base_url +'/'+ row.image}" class="img-thumbnail" width="200px">`;
                        },
                    },
                    {title: 'Created', data: 'created_at', className: 'text-center', width: '20%'},
                    {
                        ...
                        width: '10%',
                        mRender: function (data, type, row) {
                            return '<a href="' + base_url + '/admin/gallery/' + row.id + '/edit" style="margin-right: 1.5rem"><i class="icon-pencil"></i></a>' +
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this image?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/gallery/delete/' + delete_id;
                                }
                            },
                        );
                    });

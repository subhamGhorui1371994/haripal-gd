...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Document</h3>
            <div class="heading-elements">
                <a href="{{ url('admin/notice') }}" class="btn btn-primary">List Documents</a>
            </div>
        </div>
        <div class="panel-body">

            {!! Form::open(['url' => 'admin/mandatory-disclosure/documents','role' => 'form', 'class'=>'form-vertical', 'id' => 'portfolio_form','files' => true ]) !!}

            <div class="form-group">
                <label class="control-label text-bold" for="title">Title <span class="required-fields">*</span></label>
                <input type="text" name="title" id="title" class="form-control" required data-msg-required="Please enter document title.">

...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Affiliation</h3>
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => 'admin/affiliations','role' => 'form', 'class'=>'form-vertical', 'id' => 'portfolio_form','files' => true ]) !!}

            <div class="form-group">
                <label class="control-label text-bold" for="title">Title <span class="required-fields">*</span></label>
                <input type="text" name="title" id="title" class="form-control" required data-msg-required="Please enter title.">
            ...
            <div class="form-group">
                ...
                <input type="url" name="link" id="link" class="form-control" required data-msg-required="Please enter the URL.">
                <span class="validation-errors"></span>
            </div>

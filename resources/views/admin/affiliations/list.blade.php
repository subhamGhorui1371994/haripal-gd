...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Affiliations</h3>
            <div class="heading-elements">
                <a href="{{ url('admin/affiliations/create') }}" class="btn btn-primary">Add Affiliation</a>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: base_url + '/admin/affiliations/get-list',
                    type: 'POST',
                ...
                columns: [
                    {data: 'title', title: 'Title'},
                    {
                        ...
                        mRender: function (data, type, row) {
                            return '<img src="' + base_url + '/' + row.logo + '" width="100" class="img-thumbnail">';
                        },
                    },
                    {data: 'link', title: 'URL'},
                    {title: 'Created', data: 'created_at', className: 'text-center'},
                    {
                        ...
                        width: '10%',
                        mRender: function (data, type, row) {
                            return '<a href="' + base_url + '/admin/affiliations/' + row.id + '/edit" style="margin-right: 1.5rem"><i class="icon-pencil"></i></a>' +
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this affiliation?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/affiliations/delete/' + delete_id;
                                }
                            },
                        );
                    });
